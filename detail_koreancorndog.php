  ...
  <div class="container mt-5 mb-5">
    <div class="row row-produk">
      <div class="col-lg-5">
        <div class="figure">
          <figure class="figure">
            <img src="img/innerpage/kc.jpg" class="figure-img img-fluid img-innerpage">
      ...
      <a href="menu.php"><button type="button" class="btn-close x-button" aria-label="Close" style="color: white;"></button></a>
        <h4 class="title-innerpage"><strong>~ Korean Corndog ~</h4>
        ...
        <h3 class="harga-produk"><strong>Rp. 25.000,-</strong></h3>
        <p class="jumlah-produk">~ 1pcs</p>
        <div class="btn-produk mt-3">
          <a href="beli.php?id=1"><button class="button-keranjang mx-2"><i class="fas fa-cart-plus"></i> Masukkan ke Keranjang </button></a>
        </div>
        ...
        <div class="row mt-5">
          ...
          <div class="tab-content p-3" id="myTabContent">
            <div class="tab-pane fade deskripsi show active" id="deskripsi" role="tabpanel" aria-labelledby="deskripsi-tab">
              <p>
                <span style="font-size: 19px;">~ Korean Corndog ~</span><br>
                Isi : Sosis Jumbo + Mozarella Mini<br>
                Topping : Saus Tomat + Mustard<br>
                Jumlah : 1pcs Jumbo.<br>
                Note : Jika makan ditempat free reffil saus.<br>
              </p>
            </div>
            <div class="tab-pane fade review" id="review" role="tabpanel" aria-labelledby="review-tab">
              <div class="row">
                <div class="col-1">
                  <img src="../../img/innerpage/1.jpg" class="img-review">
                </div>
                <div class="col">
              ...
              <div class="row">
                <div class="col-1">
                  <img src="../../img/innerpage/2.jpg" class="img-review">
                </div>
                <div class="col">
                  <h5 class="nama-pelanggan">Carissa Azkadina</h5>
                  <p class="komentar-pelanggan">Bunganya segar dan harum. </p>
                </div>
              </div>
              <div class="row">
                <div class="col-1">
                  <img src="../../img/innerpage/3.jpg" class="img-review">
                </div>
                <div class="col">
              ...
              <div class="row">
                <div class="col-1">
                  <img src="../../img/innerpage/5.jpg" class="img-review">
                </div>
                <div class="col">
                  <h5 class="nama-pelanggan">Jasmine Aisyah</h5>
                  <p class="komentar-pelanggan">Recomended bgt order bunga disini, aman dan terpercaya.</p>
                </div>
              </div>
              <div class="row">
                <div class="col-1">
                  <img src="../../img/innerpage/4.jpg" class="img-review">
                </div>
                <div class="col">
                  <h5 class="nama-pelanggan">Rio Denandra</h5>
                  <p class="komentar-pelanggan">Gak nyesel beli disini, packagingnya vibes bunga mahal.</p>
                </div>
              </div>
