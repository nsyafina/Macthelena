  ...
  <div class="container mt-5 mb-5">
    <div class="row row-produk">
      <div class="col-lg-5">
        <div class="figure">
          <figure class="figure">
            <img src="../img/innerpage/13.jpg" class="figure-img img-fluid img-innerpage">
      ...
      <a href="../menu.php"><button type="button" class="btn-close x-button" aria-label="Close" style="color: white;"></button></a>
        <h4 class="title-innerpage"><strong>~ Kwetiauw Goreng ~</h4>
        ...
        <h3 class="harga-produk"><strong>Rp. 32.000,-</strong></h3>
        <p class="jumlah-produk">~ 1 porsi</p>
        <div class="btn-produk mt-3">
          <a href="beli.php?id=13"><button class="button-keranjang mx-2"><i class="fas fa-cart-plus"></i> Masukkan ke Keranjang </button></a>
        </div>
        ...
        <div class="row mt-5">
          ...
          <div class="tab-content p-3" id="myTabContent">
            <div class="tab-pane fade deskripsi show active" id="deskripsi" role="tabpanel" aria-labelledby="deskripsi-tab">
              <p>
                <span style="font-size: 19px;">~ Kwetiauw Goreng ~</span><br>
                Isi : Kwetiauw Goreng<br>
                Topping : Daging sapi + Telur Acak + Sawi Ijo + Kol + Acar.<br>
            </div>
